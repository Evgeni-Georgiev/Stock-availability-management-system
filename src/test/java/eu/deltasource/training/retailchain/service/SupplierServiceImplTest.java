...
class SupplierServiceImplTest {
    ...
    void setUp() {
        ...
        classUnderTest = new SupplierServiceImpl(supplierRepository);
    }
    ...
    public void should_updateSupplier_when_valid_data() {
        ...
        // Then
        assertEquals(classUnderTest.update(supplier.getId(), mapToSupplierDTO(supplier)).getName(), supplier.getName());
        verify(supplierRepository).save(supplier);
    }
